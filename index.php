				...
				<div class="container">
					<div class="row fullscreen d-flex align-items-center">
						<div class="banner-content col-lg-7 col-md-6 justify-content-center ">
							...
							<p class="text-white">
                                We are proud to be a 100% Capetown owned and operated company and because of our long serving history and knowledge within the industry we are able to support a large range of devices, from Apple to HP, Laptops to Desktops and more.
                            </p>
					...
					<div class="row">
						<div class="col-lg-3 col-md-6">
							<div class="single-service">
								...
								<h4>VIRUS REMOVAL</h4>
								<p>
                                    We will detect and remove all viruses and spyware from your computer. We also repair any damage the virus may have caused to your Windows installation or files.
								</p>
							</div>
						</div>
						<div class="col-lg-3 col-md-6">
							<div class="single-service">
								...
								<h4>Networking</h4>
								<p>
                                    Have all those cables got your brain feeling tangled? Let us help you make sense of it all, or better yet, how about a wireless solution
								</p>
							</div>
						</div>
						<div class="col-lg-3 col-md-6">
							<div class="single-service">
								...
								<p>
                                    When you feel its time to replace your computer we'll order your same old favorite or customize a brand new one for you instead.
								</p>
							</div>
						</div>	
						<div class="col-lg-3 col-md-6">
							<div class="single-service">
								...
								<h4>HARDWARE & SOFTWARE UPGRADES</h4>
								<p>
                                    Upgrades, brand new software and removing pesky viruses for your PC or Apple - we've got all you need when it comes to computer software.
								</p>
							</div>
						</div>																		
					</div>
				...
				<div class="container">
					<div class="row align-items-center justify-content-start">
						<div class="col-lg-6 no-padding home-about-right">
							...
							<p>
                                We develop both window, web and mobile application softwares at an affordable cost.This can help to improve on efficiency your day to day work for your business or company hance leading to its developemnt and increass in productivity
							</p>
				...
				<div class="container">
					<div class="row align-items-center justify-content-between no-gutters">
						<div class="col-lg-6 discount-left">
							<h1 class="text-white">Enjoy 25% Seasonal Discount!</h1><br><br>
<!--							<p class="text-white">-->
